...
def test_quarter_triplet_across_a_barline():
    ...
    mei, out = _mei('Panola.scoreAsMEI([Panola("c5_2 d5_4 e5_4*2/3 f5 g5")], [( measure: 1, meter: "4/4", key: \\Cmajor )], [\\treble], nil)')
...
def test_noncrossing_tuplets_unchanged():
    ...
    trip, _ = _mei('Panola.scoreAsMEI([Panola("c5_4*2/3 d5 e5")], [( measure: 1, meter: "4/4", key: \\Cmajor )], [\\treble], nil)')
    assert trip.count("<tuplet ") == 1 and trip.count('<note dur="4"') == 3, trip
    sept, _ = _mei('Panola.scoreAsMEI([Panola("c5_16*4/7 d5 e5 f5 g5 a5 b5 c6_2 r_4")], [( measure: 1, meter: "4/4", key: \\Cmajor )], [\\treble], nil)')
