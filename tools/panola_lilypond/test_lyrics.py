...
def test_lyrics_basic():
    ly = gen(r'Panola.scoreAsLilypond([Panola("c5_4 d5 e5 f5")], [( measure: 1, meter: "4/4", key: \Cmajor )], [\treble], nil, nil, nil, [ [ "Twin-kle lit-tle" ] ])')
...
def test_lyrics_melisma_and_multiverse():
    ly = gen(r'Panola.scoreAsLilypond([Panola("c5_4 d5 e5 f5")], [( measure: 1, meter: "4/4", key: \Cmajor )], [\treble], nil, nil, nil, [ [ "A _ men", "one two three four" ] ])')
