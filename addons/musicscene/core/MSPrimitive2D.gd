@tool
class_name MSPrimitive2D
extends Node2D
## A single Node2D that draws one built-in visual primitive (rect / circle / line / text).
## Sizes/positions are in local pixels; the MSObject wrapper handles coordinate mapping.
